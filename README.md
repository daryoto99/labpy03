...
# algoritma 
      1.Mulai.
      2.Import fungsi random() dari modul random.

      3.Minta pengguna memasukkan nilai n (jumlah bilangan acak yang ingin ditampilkan).

      4.Inisialisasikan variabel penghitung i = 1.

      5.ulangi Selama (i <= n), lakukan langkah berikut:
      a. Bangkitkan satu bilangan acak a menggunakan fungsi random().
      b. Jika a < 0.5, maka:Tampilkan nilai a bersama nomor urutan data nya

      c.Tambahkan nilai i dengan 1.

      5.Jika semua n bilangan sudah ditampilkan, cetak tulisan "Selesai".
